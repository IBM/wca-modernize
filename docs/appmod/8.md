...
4. With the `was_dependency` folder now prepared with the necessary drivers, the `modresorts` application is ready to *build* and *deploy* a live WebSphere Application Server-hosted site.
